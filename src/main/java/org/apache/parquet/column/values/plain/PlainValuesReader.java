...
abstract public class PlainValuesReader extends ValuesReader {
    private static final Log LOG = Log.getLog(org.apache.parquet.column.values.plain.PlainValuesReader.class);
    ...
    public static class DoublePlainValuesReader extends org.apache.parquet.column.values.plain.PlainValuesReader {
    ...
    public static class FloatPlainValuesReader extends org.apache.parquet.column.values.plain.PlainValuesReader {
    ...
    public static class IntegerPlainValuesReader extends org.apache.parquet.column.values.plain.PlainValuesReader {
    ...
    public static class LongPlainValuesReader extends org.apache.parquet.column.values.plain.PlainValuesReader {
