...
public class BitPacking {
    ...
    abstract public static class BitPackingReader {
        ...
        public void skip(long numSkip) throws IOException {
    ...
    public static BitPackingWriter getBitPackingWriter(int bitLength, OutputStream out) {
        switch (bitLength) {
            case 0:
                return new org.apache.parquet.column.values.bitpacking.ZeroBitPackingWriter();
            case 1:
                return new org.apache.parquet.column.values.bitpacking.OneBitPackingWriter(out);
            case 2:
                return new org.apache.parquet.column.values.bitpacking.TwoBitPackingWriter(out);
            case 3:
                return new org.apache.parquet.column.values.bitpacking.ThreeBitPackingWriter(out);
            case 4:
                return new org.apache.parquet.column.values.bitpacking.FourBitPackingWriter(out);
            case 5:
                return new org.apache.parquet.column.values.bitpacking.FiveBitPackingWriter(out);
            case 6:
                return new org.apache.parquet.column.values.bitpacking.SixBitPackingWriter(out);
            case 7:
                return new org.apache.parquet.column.values.bitpacking.SevenBitPackingWriter(out);
            case 8:
                return new org.apache.parquet.column.values.bitpacking.EightBitPackingWriter(out);
            default:
    ...
    public static BitPackingReader createBitPackingReader(int bitLength, InputStream in, long valueCount) {
        switch (bitLength) {
            case 0:
                return new org.apache.parquet.column.values.bitpacking.ZeroBitPackingReader();
            case 1:
                return new org.apache.parquet.column.values.bitpacking.OneBitPackingReader(in);
            case 2:
                return new org.apache.parquet.column.values.bitpacking.TwoBitPackingReader(in);
            case 3:
                return new org.apache.parquet.column.values.bitpacking.ThreeBitPackingReader(in, valueCount);
            case 4:
                return new org.apache.parquet.column.values.bitpacking.FourBitPackingReader(in);
            case 5:
                return new org.apache.parquet.column.values.bitpacking.FiveBitPackingReader(in, valueCount);
            case 6:
                return new org.apache.parquet.column.values.bitpacking.SixBitPackingReader(in, valueCount);
            case 7:
                return new org.apache.parquet.column.values.bitpacking.SevenBitPackingReader(in, valueCount);
            case 8:
                return new org.apache.parquet.column.values.bitpacking.EightBitPackingReader(in);
            default:
                throw new UnsupportedOperationException("only support up to 8 for now");
        }
    }
...
class OneBitPackingReader extends BitPackingReader {
    ...
    @Override
    public void skip(long numSkip) throws IOException {
        long skipInBuffer = Math.min(numSkip, count);
        count -= skipInBuffer;
        numSkip -= skipInBuffer;

        if (numSkip > 0) {
            long skipInBytes = numSkip >>> 3;
            in.skip(skipInBytes);
            numSkip -= (skipInBytes << 3);
        }
...
class ThreeBitPackingWriter extends org.apache.parquet.column.values.bitpacking.BaseBitPackingWriter {
...
class ThreeBitPackingReader extends org.apache.parquet.column.values.bitpacking.BaseBitPackingReader {
    ...
    public void skip(long numSkip) throws IOException {
        ...
        count -= skipInBuffer;
        numSkip -= skipInBuffer;
        totalRead += skipInBuffer;
        if (numSkip > 0) {
            long skipGroup = numSkip >>> 3;
            long skipInBytes = skipGroup * 3;
            in.skip(skipInBytes);
            numSkip -= (skipGroup << 3);
            totalRead += (skipGroup << 3);
        }
        // Use read to process the remaining
        for (long i = 0; i < numSkip; i++) {
            read();
...
class FiveBitPackingWriter extends org.apache.parquet.column.values.bitpacking.BaseBitPackingWriter {
...
class FiveBitPackingReader extends org.apache.parquet.column.values.bitpacking.BaseBitPackingReader {
...
class SixBitPackingWriter extends org.apache.parquet.column.values.bitpacking.BaseBitPackingWriter {
...
class SixBitPackingReader extends org.apache.parquet.column.values.bitpacking.BaseBitPackingReader {
...
class SevenBitPackingWriter extends org.apache.parquet.column.values.bitpacking.BaseBitPackingWriter {
...
class SevenBitPackingReader extends org.apache.parquet.column.values.bitpacking.BaseBitPackingReader {
