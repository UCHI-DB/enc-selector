...
public class GlobalFileProducer4Addr {
    ...
    public static void main(String[] args) throws IOException, VersionParser.VersionParseException {
        ...
        String addr = "../datasets/tpc-ds/customer_address_merged.dat";
        ...
        //Object2IntMap dictMap = ParquetWriterHelper.buildGlobalDict(new File(addr).toURI(),col,TPCHSchema.lineitemSchema(),ordered, 0);
        //System.out.println(dictMap);
        //EncContext.globalDict.get().put(TPCHSchema.lineitemSchema().getColumns().get(col).toString(), dictMap);

        ParquetWriterHelper.write(new File(addr).toURI(), TPCHSchema.customeraddmergedSchema(),
